...
<body>
    <div
        class="flex flex-col justify-center w-1/3 min-h-screen px-4 py-6 m-auto antialiased text-gray-800 bg-gray-100 dark:bg-gray-700 sm:py-12">
        <div class="relative py-3 mx-auto text-center sm:max-w-xl">
            ...
            <div class="relative mt-4 text-left bg-white shadow-md sm:rounded-lg dark:bg-gray-700">
                ...
                <div class="px-8 py-6">
                    <form method="POST" action="/login">
                        ...
                        <div class="relative py-4">
                            ...
                            @error('email')
                                <p class="text-xs italic text-red-500 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex items-baseline justify-between">
                            <button class="px-6 py-2 mt-6 text-white bg-blue-500 rounded-lg" type="submit">Login
                                <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-6" fill="none"

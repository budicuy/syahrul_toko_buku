        ...
        <form action="/barang" method="post">
            ...
            <div class="mb-3">
                <label for="namaBarang" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nama
                    Barang</label>
                <input type="text" id="default-input" placeholder="nama barang" name="nama"
                    value="{{ old('nama') }}"
  ...
  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="harga" id="hargaBarang" placeholder="1.2000.000"
                    class="relative w-full px-3 py-3 text-sm bg-white border-0 rounded shadow outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder-slate-300 text-slate-600 focus:outline-none focus:ring" />
                @error('harga')
                    <p class="text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="stok_barang" id="stokBarang" placeholder="10"
                    class="relative w-full px-3 py-3 text-sm bg-white border-0 rounded shadow outline-none placeholder-slate-300 text-slate-600 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" />
                @error('stok_barang')
                    <p class="text-red-500">{{ $message }}</p>
                @enderror
            </div>
